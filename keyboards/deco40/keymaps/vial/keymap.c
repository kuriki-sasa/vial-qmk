...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho(
        ...
        KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_RBRC, KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_QUOT, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [2] = { ENCODER_CCW_CW(KC_VOLD, RGB_VAI), ENCODER_CCW_CW(KC_VOLD, RGB_SPI), ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
};
#endif